...
a persistence unit "carrobePersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "carrobe/pom.xml":
...
artifact ("carrobe.war") is already built. You can build
